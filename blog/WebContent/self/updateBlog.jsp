...
<div class="layui-layout layui-layout-admin">
    ...
    <div style="padding: 15px;">
		<form class="layui-form" lay-filter="updateblog" method="post" action="<%=cpath%>/AddBlog">
			...
			<div class="layui-form-item">
  			...
  			<div class="layui-form-item">
  				<div class="layui-input-block">
  					<input name = "method" style="display:none" value="update_blog" />
  					<input name = "blog_id" style="display:none"  />
...
<%	List<Category> cl = (List<Category>)session.getAttribute("category_list");
	String bj = (String)session.getAttribute("ablog");
	session.removeAttribute("category_list");
	session.removeAttribute("ablog");
...
<% } } %>
  ...
  <%if(null != bj){%>
  	var b = JSON.parse('<%=bj%>');
  <%}%>
  layform.val("updateblog", {
	  "title": b.title // "name": "value"
